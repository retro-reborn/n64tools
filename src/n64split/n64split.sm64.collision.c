...
const terrain_t terrain_table[] = {
    {0x0000, "normal"},         {0x0001, "lethal_lava"},
    {0x0005, "hang"},           {0x000A, "deathfloor"},
    {0x000E, "water_currents"}, {0x0012, "void"},
    {0x0013, "very_slippery"},  {0x0014, "slippery"},
    {0x0015, "climbable"},      {0x0028, "wall"},
    {0x0029, "grass"},          {0x002A, "unclimbable"},
    {0x002C, "windy"},          {0x002E, "icy"},
    {0x0030, "flat"},           {0x0036, "snowy"},
    {0x0037, "snowy2"},         {0x0076, "fence"},
    {0x007B, "vanishing_wall"}, {0x00FD, "pool_warp"},
};
...
int collision2obj(char *binfilename, unsigned int binoffset, char *objfilename,
  ...
  fprintf(fobj,
          "# collision model generated from n64split v%s\n"
          "# level %s %05X\n"
          "\n"

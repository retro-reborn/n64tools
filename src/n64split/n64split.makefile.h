static const char makefile_data[] =
    ...
    "\n"
    "clean:\n"
    "\tdel /Q $(call FixPath,$(BUILD_DIR)/$(TARGET).elf "
    "$(BUILD_DIR)/$(TARGET).o $(BUILD_DIR)/$(TARGET).bin "
    "$(BUILD_DIR)/$(TARGET).map $(TARGET).z64)\n"
    "\n"
    ...
    "\tmkdir $(BUILD_DIR)\n"
    "\n"
    "$(BUILD_DIR)/$(TARGET).o: $(TARGET).s Makefile $(MAKEFILE_SPLIT) "
    "$(MIO0_FILES) $(LEVEL_FILES) $(MUSIC_FILES) | $(BUILD_DIR)\n"
    "\t$(AS) $(ASFLAGS) -o $@ $<\n"
    "\n"

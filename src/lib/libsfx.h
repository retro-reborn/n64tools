...
// returns a sound_data_header which contains info about all the sounds stored
// in the rom
...
// key_base: not entirely sure what this is, but it's converted & stored in the
// new .wav file snd_data: buffer containing the raw, encoded sound data
// sampling_rate: sample rate for the sound data (higher sampling rate = wav
// file speeds up) returns 1 if the .wav file was created, 0 if not
